...
# PREREQ: Grant the vaultMSI the required persmissions on the vault and RG before running the script
# Target: /subscriptions/<subscriptionIdGuid>/resourceGroups/testrg/providers/Microsoft.DataProtection/BackupVaults/testvault/backupInstances/pgflexrestore-pgflexrestore-828e8752-f4b0-4c3e-a11d-bf34c050f032

$vaultSubscriptionId = "subscriptionIdGuid"
$vaultResourceGroup = "testrg"
$vaultName = "testvault"
$vaultRegion = "westcentralus"
$backupInstanceName = "pgflexresource-pgflexresource-828e8752-f4b0-4c3e-a11d-bf34c050f032" #provide name for the BI

# Datasource details
$datasourceSubscriptionId = "subscriptionIdGuid"
$datasourceResourceGroup = "pgflexrg"
$datasourceServerName = "pgflexresource"
...
$putResponse = Invoke-WebRequest -Method PUT -Uri $uri -Headers $headers -Body $body -UseBasicParsing
